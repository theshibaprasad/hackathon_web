        ...
        >
          ...
          <div className="w-full max-w-md mx-auto mb-12">
            <div className="flex items-center justify-between mb-2">
              <div className="w-4 h-4 bg-devfolio-purple rounded-full"></div>
              <div className="flex-1 h-1 bg-muted mx-2"></div>
              <div className="w-4 h-4 bg-muted rounded-full"></div>
              <div className="flex-1 h-1 bg-muted mx-2"></div>
              <div className="w-4 h-4 bg-devfolio-green rounded-full"></div>
            </div>
          </div>
        </motion.div>

        {/* Center the single hackathon card with a bigger container (80% of screen width) */}
        <div className="flex justify-center">
          <div className="grid grid-cols-1 gap-8 w-full" style={{ maxWidth: '80%' }}>
            {hackathons.map((hackathon, index) => (
              <motion.div
                ...
                className={`${hackathon.color} p-12 rounded-3xl text-white relative overflow-hidden cursor-pointer group`}
                style={{
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-5xl font-bold mb-6 group-hover:text-blue-200 transition-colors">
                    {hackathon.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-3xl opacity-90">{hackathon.date}</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <Trophy className="w-8 h-8 text-yellow-400" />
                      <p className="text-2xl opacity-80 font-semibold">Winner Prize</p>
                    </div>
                  </div>
                  ...
                  >
                    <Button 
                      variant="secondary" 
                      className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border-0 text-2xl py-5 px-10 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 font-semibold"
                    >
